...
-- Insert realistic transcripts for the calls (using correct speaker values: 'caller' and 'agent')
INSERT INTO public.transcripts (call_id, speaker, message, confidence, intent, timestamp) 
SELECT 
    c.id,
    'agent',
    ...
    0.95,
    'greeting',
    c.started_at + INTERVAL '5 seconds'
FROM public.calls c
...
SELECT 
    ...
    0.92,
    'appointment_request',
    c.started_at + INTERVAL '15 seconds'
FROM public.calls c
...
SELECT 
    ...
    0.96,
    'information_request',
    c.started_at + INTERVAL '30 seconds'
FROM public.calls c
WHERE c.call_status = 'completed'
...
SELECT 
    ...
    c.started_at + INTERVAL '45 seconds'
FROM public.calls c
WHERE c.call_status = 'completed'
...
SELECT 
    ...
    0.97,
    'confirmation',
    c.started_at + INTERVAL '90 seconds'
FROM public.calls c
WHERE c.call_status = 'completed'
...
SELECT 
    ...
    0.93,
    'gratitude',
    c.started_at + INTERVAL '120 seconds'
FROM public.calls c
WHERE c.call_status = 'completed'
...
SELECT 
    ...
    0.91,
    'inquiry',
    c.started_at + INTERVAL '10 seconds'
FROM public.calls c
...
SELECT 
    ...
    0.95,
    'information_request',
    c.started_at + INTERVAL '25 seconds'
FROM public.calls c
WHERE c.call_status = 'partial_completed'
...
SELECT 
    ...
    0.89,
    'callback_request',
    c.started_at + INTERVAL '60 seconds'
FROM public.calls c
WHERE c.call_status = 'partial_completed'
...
SELECT 
    ...
    0.90,
    'appointment_inquiry',
    c.started_at + INTERVAL '8 seconds'
FROM public.calls c
...
SELECT 
    ...
    0.96,
    'information_request',
    c.started_at + INTERVAL '20 seconds'
FROM public.calls c
WHERE c.call_status = 'in-progress'
...
SELECT 
    ...
    0.98,
    'sms_acknowledgment',
    c.started_at + INTERVAL '2 seconds'
FROM public.calls c
