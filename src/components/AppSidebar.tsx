  ...
  return <Sidebar>
      <SidebarContent>
        <div className="p-4">
          ...
          {!open && <div className="text-center text-sm font-bold">mAI</div>}
        </div>
        ...
        {isPremiumPlus && <SidebarGroup>
            <SidebarGroupLabel>Premium+ Features</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
                {premiumItems.map(item => <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <NavLink to={item.url} end className={({
                  isActive
                }) => getNavCls({
        ...
        {open && !isPremiumPlus && profile?.plan_type === 'free' && <SidebarGroup>
            <SidebarGroupContent>
      ...
      {hasRole('super_user') && <div className="border-t">
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  ...
                  isActive
                }) => cn("flex items-center gap-2 p-2 rounded-lg transition-colors", isActive ? "bg-red-100 text-red-900 font-medium" : "text-muted-foreground hover:text-foreground hover:bg-muted")}>
